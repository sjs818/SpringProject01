			...
			<div class="col-sm-6">
				<div class="card shadow">
					<div class="card-body">
						...
						<form:form action="${root }spot/modify_proc" method="post" modelAttribute="modifySpotDTO" enctype="multipart/form-data">
							<div class="form-group">
								<form:hidden path="spot_idx" />
							...
							<div class="form-group">
								...
								<form:textarea path="spot_content" rows="10"
									class="form-control" placeholder="입력하세요." style="resize:none"></form:textarea>
							</div>

							<c:if test="${modifySpotDTO.spot_file != null }">
								<div class="form-group">
									<label for="spot_file">첨부 이미지</label> 
									<img src="${root }images/spot/${modifySpotDTO.spot_file}" width="100%" />
