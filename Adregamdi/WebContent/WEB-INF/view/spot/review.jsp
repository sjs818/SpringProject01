...
<body>
	...
	<!-- 1개 클릭 시 세부사항 -->
	<div class="container bg-light" style="margin-top: 150px; margin-bottom: 150px; font-color: black;">
		<table id="table">
			<tr>
				<td>
					<div class="text-center">
						<h1 class="section-heading" style="font-size: 50px;"><b>${information[1] }</b></h1>
						<h3 class="section-subheading text-muted">${information[3] }
						</h3>
						<br>
						<br>
					</div>
			...
			<tr>
				<td class="left text-center"><img class="img-fluid photo"
					src="${information[0] }" alt="img" /></td>
