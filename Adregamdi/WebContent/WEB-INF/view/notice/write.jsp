      ...
      <div class="col-sm-8">
        <div class="panel">
          <div class="panel-body">
            <form:form action="${root}notice/writeProc" method="post" modelAttribute="noticeWriteDTO" class="form-horizontal">
              ...
              <div class="form-group">
              	 <div class="text-center">
                 	...
                 	<a href="${root}notice/list" class="btn btn-danger">취소</a>
              	 </div>
              </div>
            </form:form>
          </div>
