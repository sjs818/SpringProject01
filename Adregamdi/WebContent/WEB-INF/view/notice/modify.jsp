  ...
  <hr><br>
   <form class="form-horizontal" name="noticeModifyProcDTO" id="noticeModifyProcDTO" action="${root}notice/modifyProc" method="POST">
    <div class="form-group" style="margin-bottom: 30px;">
      <div class="mb-3">
        <label for="notice_title" style="font-size:1.1em; margin-left: 5px; padding-bottom: 5px;"><b>제 목</b></label>
        <input class="form-control" type="text" id="notice_title" name="notice_title" value="${noticeModifyDTO.notice_title}">
        <input class="form-control" type="text" id="notice_no" name="notice_no" value="${noticeModifyDTO.notice_no }" style="display:none;">
      </div>
    </div>
    <div class="form-group" style="margin-bottom: 30px;">
      <div class="mb-3">
        <label for="notice_content" style="font-size:1.1em; margin-left: 5px; padding-bottom: 5px;"><b>내 용</b></label>
